package com.chenxiao.generators.test;
...
public class MpGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/room_install?useUnicode=true&characterEncoding=utf8&allowMultiQueries=true&serverTimezone=UTC");
        ...
        pc.setParent("com");
        pc.setModuleName("chenxiao.generators");
        ...
        InjectionConfig cfg = new InjectionConfig() {
            ...
            public void initMap() {
                ...
                map.put("chenxiao", this.getConfig().getGlobalConfig().getAuthor() + "的模板生成完成！");
                this.setMap(map);
            }
        };
 ...
 /*       focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return dirPath + "/src/main/resources/mapper/"
...
/*        TemplateConfig tc = new TemplateConfig();
        ...
        // 打印注入设置【可无】
        System.err.println(mpg.getCfg().getMap().get("chenxiao"));
    }
